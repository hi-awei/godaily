            ...
            <div class="tool-detail-info">
                ...
                <div class="tool-detail-badges">
                    <span class="badge" style="background:<?php echo category_color($tool['category']); ?>20;color:<?php echo category_color($tool['category']); ?>">
                        <?php echo strtoupper($tool['category']); ?>
                    </span>
                ...
                <div class="card">
                    ...
                    <div class="related-tools">
                        <?php foreach ($related as $r): ?>
                            <a href="tool.php?slug=<?php echo $r['slug']; ?>" class="related-item">
            ...
            <aside class="tool-detail-sidebar">
                ...
                <div class="card share-card">
                    ...
                    <div class="share-btns">
                        <button onclick="copyLink()" class="share-btn">📋 复制链接</button>
                        <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode($tool['name'] . ' - ' . SITE_NAME); ?>" target="_blank" class="share-btn">🐦 分享到X</a>
                    </div>
                </div>
            </aside>
        </div>
